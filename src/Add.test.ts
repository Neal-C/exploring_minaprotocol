...
import { describe, it, beforeEach, beforeAll } from 'bun:test';
...
describe('Add', () => {
  ...
  //! Code from default template fails
  it.skip('correctly settles `AddZKprogram` state on the `Add` smart contract', async () => {
    await localDeploy();
